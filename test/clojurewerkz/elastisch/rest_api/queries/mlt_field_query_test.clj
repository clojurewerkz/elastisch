...
(let [conn (rest/connect)]
  ...
  (let [index-name   "articles"
        ...
        response     (doc/search conn index-name mapping-type :query (q/mlt-field :tags {:tags {:like_text "technology, opensource, search, full-text search, distributed, software, lucene"
